...
function wrapper (obj1, obj2) {
  ...
  return deepEqual(obj1, obj2, cache1, cache2)
}
 ...
 * @param cache2
 */
function deepEqual (obj1, obj2, cache1, cache2) {
  ...
  if (Object.getPrototypeOf(obj1) === Object.getPrototypeOf(obj2)) {
    ...
    return object1Keys.every((key) => deepEqual(obj1[key], obj2[key], cache1, cache2))
  }
